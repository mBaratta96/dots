local personal_home = vim.fn.expand("~/Documenti/projects/personal/")
local notes_home = vim.fn.expand("~/Documenti/projects/notes")

local home = notes_home
local vault_home = personal_home
